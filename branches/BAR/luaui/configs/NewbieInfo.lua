...
local lines = {
    ...
    [14] = "Press \255\255\150\000f4\255\255\255\255 to highlight where metal spots are.",
    ...
    [20] = "You can find out all the hotkeys from within this menu - use the dropdown menu on the right to change the text inside this window!",
    [21] = "",
