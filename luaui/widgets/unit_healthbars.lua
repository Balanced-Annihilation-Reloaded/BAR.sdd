...
local bkInnerBottom   = { 0.05,0.05,0.05,barInnerAlpha }
local bkInnerTop      = { 0.33,0.33,0.33,barInnerAlpha*0.8 }
...
local barColors = {
  ...
  reload  = { 0.05,0.60,0.60,barValueAlpha*0.4 },
